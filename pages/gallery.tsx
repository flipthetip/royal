...
const [allowed, setAllowed] = useState(false)
  ...
  return (
    <div>
      ...
      <Head>
        <title>GALLERY</title>
        <meta name='description' content='View your Royal Gallery' />
        <link rel='icon' href='/favicon.ico' />
      </Head>
      
      <div className='drawer drawer-end align-items-center'>
...
<br/>
<br/>
          <h2 className='font-bold mt-6'>THE GALLERY 🖼️<br/></h2>
...
<br/>
          ...
          <div className='container px-4'>
            <div className='ml-6 mr-6 mb-20 grid grid-cols-2 gap-1 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
              {nfts
                .filter(n => n.name.includes("The Shady Class"))
                .sort ((a: Nft, b:Nft) => {
